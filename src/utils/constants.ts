...
export const ACTION_EFFECTS = {
  feed: { hunger: 30, happiness: 5, energy: 0, hygiene: -5, health: 0 },
  play: { hunger: -8, happiness: 22, energy: -12, hygiene: -6, health: 0 },
  sleep: { hunger: -3, happiness: 3, energy: 35, hygiene: 0, health: 1 },
  clean: { hunger: 0, happiness: 3, energy: 0, hygiene: 35, health: 0 },
  pet: { hunger: 0, happiness: 12, energy: 0, hygiene: 0, health: 0 },
  medicine: { hunger: 0, happiness: 0, energy: 0, hygiene: 0, health: 30 }
} as const
