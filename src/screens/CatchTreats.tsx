  ...
  if (ended) {
    return (
      <motion.div
        ...
        className="flex flex-col items-center justify-center gap-6 h-full my-auto"
      >
        <h1 className="text-primary text-xl">Time's up!</h1>
        <i
          className={`hn hn-${score > 10 ? 'face-heart-eyes-solid' : score > 2 ? 'face-grin-solid' : 'face-sad-solid'} text-6xl text-primary`}
        />
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <div className="flex items-center gap-6 mt-1">
        <button
          className="text-primary opacity-70 active:opacity-100 active:scale-90 transition-transform select-none touch-none"
          onPointerDown={() => {
            keys.current.left = true
          }}
          onPointerUp={() => {
        ...
        >
          <i className="hn hn-arrow-alt-circle-left-solid text-5xl" />
        </button>
        <button
          className="text-primary opacity-70 active:opacity-100 active:scale-90 transition-transform select-none touch-none"
          onPointerDown={() => {
        ...
        >
          <i className="hn hn-arrow-alt-circle-right-solid text-5xl" />
        </button>
      </div>
